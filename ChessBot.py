...
def minimaxWhite(gameState, maximizingPlayer,  depth = 0, alpha = -sys.maxint, beta = sys.maxint):
    pygame.event.get()
    bestMove = None
...
def minimaxBlack(gameState, maximizingPlayer,  depth = 0, alpha = -sys.maxint, beta = sys.maxint):
    pygame.event.get()
    bestMove = None
    moves = gameState.getValidMoves()
